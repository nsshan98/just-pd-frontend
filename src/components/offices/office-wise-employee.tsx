...
const OfficeWiseEmployee = () => {
  ...
  const officeName = officeWiseEmployeeQuery.data?.message;

  if (officeWiseEmployeeQuery.isLoading || officeWiseEmployeeQuery.isFetching) {
    return (
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 px-3 py-3">
        {officeWiseEmployeeQuery.data?.data.map(
...
export default OfficeWiseEmployee;
